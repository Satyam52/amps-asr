...
from .modified_layers.conformer import ConformerBlock as ModifiedConformerBlock
...
class Wav2Vec2EncoderBuilder:
    ...
    def build_conformer_block(self) -> TransformerEncoderLayer:
        ...
        speech_language_adaptor_ffn = self.build_text_language_adaptor_ffn()

        ## Modified Conformer Block with ffn speech language adaptor
        return ModifiedConformerBlock(
            ffn1,
            self_attn,
            conv,
            ffn2,
            ...
            device=self.device,
            dtype=self.dtype,
            speech_language_adaptor_ffn=speech_language_adaptor_ffn
        )
    ...
    def build_text_language_adaptor_ffn(self, use_swish: bool = False) -> FeedForwardNetwork:
        """Build a Transformer feed-forward network."""
        inner_dim = 2048
