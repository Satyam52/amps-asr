...
from fairseq2.nn.transformer.attention_mask import AttentionMaskFactory, CausalAttentionMaskFactory, MLMAttentionMaskFactory
from fairseq2.typing import DataType, Device
from .decoder.layer import StandardTransformerDecoderLayer as ModifiedStandardTransformerDecoderLayer
...
class NllbBuilder:
    ...
    def build_decoder_layer(self) -> TransformerDecoderLayer:
        ...
        ffn = self.build_ffn()
        text_language_adaptor_ffn = self.build_text_language_adaptor_ffn()
        ...
        ## Modified decoder layer with ffn for text language adaptor
        return ModifiedStandardTransformerDecoderLayer(
            self_attn,
            encoder_decoder_attn,
            ffn,
            dropout_p=self.config.dropout_p,
            ...
            device=self.device,
            dtype=self.dtype,
            text_language_adaptor_ffn=text_language_adaptor_ffn,
        )
    ...
    def build_text_language_adaptor_ffn(self) -> FeedForwardNetwork:
        """Build a Transformer feed-forward network."""
        inner_dim = 2048
